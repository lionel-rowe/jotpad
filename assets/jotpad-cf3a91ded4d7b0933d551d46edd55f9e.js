...
n.default.API_HOST&&(r.host=n.default.API_HOST)
var i=t.default.JSONAPIAdapter.extend(a.default,r)
...
var a=t.default.API_HOST?t.default.API_HOST+"/oauth/token":"/oauth/token",r=n.default.extend({serverTokenEndpoint:a})
...
var t=Ember.Controller.extend({})
e.default=t}),define("jotpad/helpers/app-version",["exports","jotpad/config/environment","ember-cli-app-version/utils/regexp"],function(e,t,n){function a(e){var a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=t.default.APP.version,i=a.versionOnly||a.hideSha,o=a.shaOnly||a.hideVersion,l=null
...
e.default=r}),define("jotpad/helpers/formatDate",["exports","dayjs","dayjs/plugin/relativeTime"],function(e,t,n){function a(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var n=[],a=!0,r=!1,i=void 0
try{for(var o,l=e[Symbol.iterator]();!(a=(o=l.next()).done)&&(n.push(o.value),!t||n.length!==t);a=!0);}catch(s){r=!0,i=s}finally{try{a||null==l.return||l.return()}finally{if(r)throw i}}return n}(e,t)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}()}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0,t.default.extend(n.default)
var r=Ember.Helper.helper(function(e){var n=a(e,1)[0],r=new Date(n)
return Ember.String.htmlSafe('<time datetime="'.concat(r.toISOString(),'" title="').concat((0,t.default)(r).format("MMMM Do YYYY, h:mm:ss a"),'">').concat((0,t.default)(r).fromNow(),"</time>"))})
e.default=r}),define("jotpad/helpers/pluralize",["exports","ember-inflector/lib/helpers/pluralize"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=t.default
...
var n=t.default
e.default=n}),define("jotpad/initializers/app-version",["exports","ember-cli-app-version/initializer-factory","jotpad/config/environment"],function(e,t,n){var a,r
...
e.default=a}),define("jotpad/initializers/ember-simple-auth",["exports","jotpad/config/environment","ember-simple-auth/configuration","ember-simple-auth/initializers/setup-session","ember-simple-auth/initializers/setup-session-service","ember-simple-auth/initializers/setup-session-restoration"],function(e,t,n,a,r,i){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var o={name:"ember-simple-auth",initialize:function(e){var o=t.default["ember-simple-auth"]||{}
o.rootURL=t.default.rootURL||t.default.baseURL,n.default.load(o),(0,a.default)(e),(0,r.default)(e),(0,i.default)(e)}}
e.default=o}),define("jotpad/initializers/export-application-global",["exports","jotpad/config/environment"],function(e,t){function n(){var e=arguments[1]||arguments[0]
...
var a=t.default.Model.extend({title:t.default.attr("string"),content:t.default.attr("string"),created_at:t.default.attr("date"),updated_at:t.default.attr("date"),formatted:Ember.computed("content",function(){return(0,n.default)(this.get("content"))}),reload:function(){this.notifyPropertyChange("updated_at"),this._super()}})
e.default=a}),define("jotpad/models/user",["exports","ember-data"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
var n=t.default
e.default=n}),define("jotpad/router",["exports","jotpad/config/environment"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
var a=n
e.default=a}),define("jotpad/routes/application",["exports","ember-simple-auth/mixins/authenticated-route-mixin","ember-simple-auth/mixins/application-route-mixin"],function(e,t,n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var a=Ember.inject.service,r=Ember.Route.extend(n.default,t.default,{currentUser:a(),beforeModel:function(){var e=this
...
e.default=r}),define("jotpad/routes/login",["exports"],function(e){function t(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var n=[],a=!0,r=!1,i=void 0
try{for(var o,l=e[Symbol.iterator]();!(a=(o=l.next()).done)&&(n.push(o.value),!t||n.length!==t);a=!0);}catch(s){r=!0,i=s}finally{try{a||null==l.return||l.return()}finally{if(r)throw i}}return n}(e,t)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}()}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=Ember.Route.extend({session:Ember.inject.service(),currentUser:Ember.inject.service(),model:function(){return this.get("store").createRecord("user")},actions:{authenticate:function(){var e=this,n=t(["email","password"].map(function(e){return document.querySelector("#".concat(e)).value}),2),a=n[0],r=n[1]
this.get("session").authenticate("authenticator:oauth2",a,r).catch(function(t){e.set("errorMessage",t.error||t)}).then(function(){e.get("currentUser").load().then(function(){e.controllerFor("application").set("currentUser",e.get("currentUser"))}),e.transitionTo("/")})}}})
e.default=n})
...
e.default=n}),define("jotpad/templates/application",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
e.default=t}),define("jotpad/utils/formatMarkdown",["exports","marked","insane","prismjs","prismjs/plugins/custom-class/prism-custom-class.min.js","prismjs/components/prism-markdown.min.js","jotpad/utils/safeURI"],function(e,t,n,a,r,i,o){function l(e){return(l="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function s(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var n=[],a=!0,r=!1,i=void 0
try{for(var o,l=e[Symbol.iterator]();!(a=(o=l.next()).done)&&(n.push(o.value),!t||n.length!==t);a=!0);}catch(s){r=!0,i=s}finally{try{a||null==l.return||l.return()}finally{if(r)throw i}}return n}(e,t)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}()}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var d=new t.default.Renderer,u=new t.default.Renderer
a.default.plugins.customClass.prefix("prism-")
for(var f={allowedAttributes:{a:["href","name","target","rel","title","tabindex"],img:["src","alt","title"],input:["type","checked","disabled"],code:["class"],span:["class"],pre:["class"],div:["data-line"],th:["align"],tr:["align"]},allowedClasses:{ul:["checklist"],a:["unstyled-link"]},allowedSchemes:["http","https","mailto"],allowedTags:["a","article","b","blockquote","br","caption","code","del","details","div","em","h1","h2","h3","h4","h5","h6","hr","i","img","input","ins","kbd","label","li","main","ol","p","pre","section","span","strike","strong","sub","summary","sup","table","tbody","td","th","thead","tr","u","ul"],filter:function(e){return[["code","language-"],["span","prism-"]].forEach(function(t){var n=s(t,2),a=n[0],r=n[1]
if(e.tag===a){var i=e.attrs.class?e.attrs.class.split(" "):[]
e.attrs.class=i.filter(function(e){return e.startsWith(r)}).join(" ")||void 0}}),!0},transformText:null},c=1;c<=6;c++)f.allowedClasses["h".concat(c)]=["heading"],f.allowedAttributes["h".concat(c)]=["id"]
...
return"<li>".concat(e).concat(t,"</li>\n")},v=function(e,t,n){var a=t?"ol":"ul",r=t&&1!==n?' start="'.concat(n,'"'):"",i=e.trim().split(/[\r\n]+/).every(function(e){return e.trim().startsWith('<li><label><input type="checkbox"')}),o=!t&&i?' class="checklist"':""
return"<".concat(a).concat(o).concat(r,">\n").concat(e,"</").concat(a,">\n")};[d,u].forEach(function(e){e.checkbox=p,e.listitem=m,e.list=v}),d.link=function(e,t,n){try{e=(0,o.default)(e)}catch(a){return n}return'<a target="_blank" rel="nofollow noreferrer" href="'.concat(e,'"').concat(t?' title="'.concat(t,'"'):"",">").concat(n,"</a>")},d.heading=function(e,t,n,a){var r=d.options.headerPrefix+a.slug(n)
return"<h".concat(t,' class="heading" id="').concat(r,'"><a class="unstyled-link" href="#').concat(r,'">').concat(e,"</a></h").concat(t,">\n")},u.link=function(e,t,n){try{e=(0,o.default)(e)}catch(a){return n}return'<a tabindex="-1" href="'.concat(e,'">').concat(n,"</a>")},u.heading=function(e,t,n,a){return"<h".concat(t,' class="heading">').concat(e,"</h").concat(t,">\n")},t.default.setOptions({highlight:function(e,t){var n=t.trim().toLowerCase()
...
var b=function(e){var a,r=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
return e=e.replace(/\[\[(.+?)\]\]/g,"<kbd>$1</kbd>"),t.default.setOptions({renderer:r?d:u}),Ember.String.htmlSafe((a=(0,t.default)(e),(0,n.default)(a,f)))}
e.default=b}),define("jotpad/utils/safeURI",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(a){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("jotpad/app").default.create({name:"jotpad",version:"0.0.0+76aa044b"})
