...
this.route("register"),this.route("login"),this.route("notes",{path:"/"},function(){e.route("new",{path:"/notes/new"}),e.route("note",{path:"/notes/:id"}),e.route("404")})})
var a=n
...
"/register"!==window.location.pathname&&this._super.apply(this,arguments)},_loadCurrentUser:function(){var e=this
return this.get("currentUser").load().catch(function(){return e.get("session").invalidate()})}})
e.default=o}),define("jotpad/routes/login",["exports","ember-simple-auth/mixins/unauthenticated-route-mixin"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=Ember.Route.extend(t.default,{session:Ember.inject.service(),currentUser:Ember.inject.service(),model:function(){return this.get("store").createRecord("user")},actions:{authenticate:function(){var e=this,t=this.context,n=t.email,a=t.password
this.get("session").authenticate("authenticator:oauth2",n,a).then(function(){e.get("currentUser").load().then(function(){e.controllerFor("application").set("currentUser",e.get("currentUser")),e.transitionTo("/")})}).catch(function(t){e.set("errorMessage",t.error||t)})}}})
...
e.default=t}),define("jotpad/routes/register",["exports","ember-simple-auth/mixins/unauthenticated-route-mixin"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=Ember.Route.extend(t.default,{session:Ember.inject.service(),currentUser:Ember.inject.service(),model:function(){return this.get("store").createRecord("user")},actions:{register:function(){var e=this,t=this.context,n=t.email,a=t.password
this.store.createRecord("user",{email:n,password:a}).save().then(function(t){e.get("session").authenticate("authenticator:oauth2",n,a).then(function(){e.get("currentUser").load().then(function(){e.controllerFor("application").set("currentUser",e.get("currentUser")),e.transitionTo("/")})}).catch(function(t){e.set("errorMessage",t.error||t)})})}}})
e.default=n}),define("jotpad/serializers/application",["exports","ember-data"],function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
var t=Ember.HTMLBars.template({id:"H9vk0wDt",block:'{"symbols":[],"statements":[[0,"\\n"],[7,"div"],[11,"class","container"],[9],[0,"\\n  "],[7,"h1"],[9],[0,"Login"],[10],[0,"\\n  "],[7,"form"],[11,"class","user-form"],[9],[0,"\\n    "],[7,"div"],[11,"class","field"],[9],[0,"\\n      "],[7,"label"],[11,"for","email"],[9],[0,"Email"],[10],[0,"\\n      "],[1,[27,"input",null,[["id","placeholder","value"],["email","snowball@kittens.com",[23,["model","email"]]]]],false],[0,"\\n    "],[10],[0,"\\n    "],[7,"div"],[11,"class","field"],[9],[0,"\\n      "],[7,"label"],[11,"for","password"],[9],[0,"Password"],[10],[0,"\\n      "],[1,[27,"input",null,[["id","placeholder","type","value"],["password","••••••••••••••••••••","password",[23,["model","password"]]]]],false],[0,"\\n    "],[10],[0,"\\n    "],[7,"div"],[11,"class","actions"],[9],[0,"\\n      "],[7,"button"],[11,"type","submit"],[9],[0,"Login"],[10],[0,"\\n      or\\n"],[4,"link-to",["register"],null,{"statements":[[0,"      Create a New Account\\n"]],"parameters":[]},null],[0,"    "],[10],[0,"\\n"],[4,"if",[[23,["errorMessage"]]],null,{"statements":[[0,"      "],[7,"p"],[9],[1,[21,"errorMessage"],false],[10],[0,"\\n"]],"parameters":[]},null],[0,"  "],[3,"action",[[22,0,[]],"authenticate"],[["on"],["submit"]]],[10],[0,"\\n"],[10],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"jotpad/templates/login.hbs"}})
...
e.default=t}),define("jotpad/templates/register",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.HTMLBars.template({id:"Zsj3CDPl",block:'{"symbols":[],"statements":[[0,"\\n"],[7,"div"],[11,"class","container"],[9],[0,"\\n  "],[7,"h1"],[9],[0,"Create New Account"],[10],[0,"\\n  "],[7,"form"],[11,"class","user-form"],[9],[0,"\\n    "],[7,"div"],[11,"class","field"],[9],[0,"\\n      "],[7,"label"],[11,"for","email"],[9],[0,"Email"],[10],[0,"\\n      "],[1,[27,"input",null,[["id","placeholder","value"],["email","snowball@kittens.com",[23,["model","email"]]]]],false],[0,"\\n    "],[10],[0,"\\n    "],[7,"div"],[11,"class","field"],[9],[0,"\\n      "],[7,"label"],[11,"for","password"],[9],[0,"Password"],[10],[0,"\\n      "],[1,[27,"input",null,[["id","autocomplete","placeholder","type","value"],["password","off","••••••••••••••••••••","password",[23,["model","password"]]]]],false],[0,"\\n    "],[10],[0,"\\n    "],[7,"div"],[11,"class","actions"],[9],[0,"\\n      "],[7,"button"],[11,"type","submit"],[9],[0,"Register"],[10],[0,"\\n      or\\n"],[4,"link-to",["login"],null,{"statements":[[0,"      Log In\\n"]],"parameters":[]},null],[0,"    "],[10],[0,"\\n"],[4,"if",[[23,["errorMessage"]]],null,{"statements":[[0,"      "],[7,"p"],[9],[1,[21,"errorMessage"],false],[10],[0,"\\n"]],"parameters":[]},null],[0,"  "],[3,"action",[[22,0,[]],"register"],[["on"],["submit"]]],[10],[0,"\\n"],[10],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"jotpad/templates/register.hbs"}})
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(a){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("jotpad/app").default.create({name:"jotpad",version:"0.0.0+b7c505ad"})
